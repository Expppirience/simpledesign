(() => {
  ...
  function oe(e) {
    ...
    i("init", () => {
      !1 === t.params.pagination.enabled ? m() : (h(), u(), c());
    }),
      i("activeIndexChange", () => {
    ...
    pe(),
      document.querySelector(".main__slider") &&
        new ae(".main__slider", {
          ...
          loop: !0,
          simulateTouch: !0,
          pagination: { el: ".slider-main__controls", clickable: !0 },
          on: {},
        }),
      document.querySelector(".slider-category-design_1") &&
        new ae(".slider-category-design_1", {
          modules: [oe, ce],
          slidesPerView: 3,
          spaceBetween: 45,
          autoHeight: !1,
          ...
          breakpoints: {
            320: {
              ...
              loop: !0,
              pagination: {
                el: ".slide-category-design__controls",
                clickable: !0,
              },
            },
            600: {
            ...
            1268: { slidesPerView: 3, spaceBetween: 45 },
          },
          on: {},
        }),
      document.querySelector(".slider-category-design_2") &&
        new ae(".slider-category-design_2", {
          modules: [oe, ce],
          slidesPerView: 3,
          spaceBetween: 45,
          autoHeight: !1,
      ...
      document.querySelector(".slider-category-design_3") &&
        new ae(".slider-category-design_3", {
          modules: [oe, ce],
          slidesPerView: 3,
          spaceBetween: 45,
          autoHeight: !1,
